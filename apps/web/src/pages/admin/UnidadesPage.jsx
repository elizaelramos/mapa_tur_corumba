...
import {
  Table, Button, Space, Tag, Modal, Form, Input, InputNumber, Switch, Select, Cascader,
...
export default function UnidadesPage() {
  ...
  const { data: categoriasHierarchyData } = useGetCategoriasHierarchyQuery()
  ...
  const hierarchy = categoriasHierarchyData?.data || { categorias: [], subcategorias: {}, segmentos: {} }
