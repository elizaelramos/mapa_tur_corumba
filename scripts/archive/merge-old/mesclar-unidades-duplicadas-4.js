// ============================================================================
// Script: Mesclar Unidades Duplicadas - Lote 4
// ============================================================================
...
const DUPLICATES = [
  { old_id: 25, new_id: 51, nome: 'PRONTO SOCORRO MUNICIPAL DR ROGERIO TAKAKI BENTO' },
];
...
async function main() {
  ...
  try {
    console.log('============================================================');
    console.log('MESCLAR UNIDADES DUPLICADAS - LOTE 4');
    console.log('============================================================\n');
    ...
    for (const dup of DUPLICATES) {
      ...
      const telefoneLooksLikeAddress = newTelefone && (
        ...
        newTelefone.toUpperCase().includes('COLOMBO') ||
