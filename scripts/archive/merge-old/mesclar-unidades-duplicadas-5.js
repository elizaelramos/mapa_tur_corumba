// ============================================================================
// Script: Mesclar Unidades Duplicadas - Lote 5
// ============================================================================
...
const DUPLICATES = [
  { old_id: 1, new_id: 53, nome: 'UBS SAO BARTOLOMEU' },
];
...
async function main() {
  ...
  try {
    console.log('============================================================');
    console.log('MESCLAR UNIDADES DUPLICADAS - LOTE 5');
    console.log('============================================================\n');
    ...
    for (const dup of DUPLICATES) {
      ...
      const telefoneLooksLikeAddress = newTelefone && (
        ...
        newTelefone.toUpperCase().includes('PERNANBUCO') ||
