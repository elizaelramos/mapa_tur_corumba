// ============================================================================
// Script: Mesclar Unidades Duplicadas - Lote 2
// ============================================================================
...
const DUPLICATES = [
  { old_id: 27, new_id: 54, nome: 'ACADEMIA DA SAUDE ARTHUR MARINHO' },
  { old_id: 28, new_id: 36, nome: 'ACADEMIA DA SAUDE CRISTO REDENTOR' },
  { old_id: 3, new_id: 43, nome: 'CEM - CENTRO DE ESPECIALIDADES MEDICAS DR FADAH SCAFF GATASS' },
  { old_id: 5, new_id: 35, nome: 'UPA 24H DR JOSE ABILIO M DE BARROS' },
];
...
async function main() {
  ...
  try {
    console.log('============================================================');
    console.log('MESCLAR UNIDADES DUPLICADAS - LOTE 2');
    console.log('============================================================\n');
