/**
 * Script para mesclar unidades duplicadas (Batch 7):
 * - UBS Gastão de Oliveira (ID 19) → Unidade Básica de Saúde Gastão de Oliveira (ID 29)
 * - UBS Dra Lucia Maria Pereira de Carvalho (ID 14) → Unidade Básica de Saúde Dra. Lucia Maria Pereira de Carvalho (ID 52)
 * 
 * Estratégia:
...
const DUPLICATES = [
  { old_id: 19, new_id: 29, nome: 'UBS GASTAO DE OLIVEIRA' },
  { old_id: 14, new_id: 52, nome: 'UBS DRA LUCIA MARIA PEREIRA DE CARVALHO' },
];
...
async function main() {
  ...
  try {
    ...
    console.log('MESCLAGEM DE UNIDADES DUPLICADAS - BATCH 7');
    console.log('='.repeat(80));
    console.log();
